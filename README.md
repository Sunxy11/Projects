...
项目初期三次走访天津市北辰区佳荣里（井田）社区，与社区管理人员了解社区的基本情况、管理上的困难等，探索互助养老的新型养老模式，根据需求确定软件的功能模块并使用用例图、活动图等可视化。
本项目利用 Java 语言，编写了一款基于 Android 的社区养老管理 APP，包含登陆注册、爱心超市兑换、一键打卡、活动信息、心愿发布等模块。
